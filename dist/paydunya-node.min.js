...
function CheckoutInvoice(e,t){Invoice.call(this,e,t),this.baseURL=this.baseURL+"/checkout-invoice"}var Invoice=require("./invoice"),request=require("superagent"),Promise=require("bluebird");CheckoutInvoice.prototype=Object.create(Invoice.prototype),CheckoutInvoice.prototype.constructor=CheckoutInvoice,CheckoutInvoice.prototype.create=function(){var e=this,t=e.generateRequestBody();return new Promise(function(o,r){request.post(e.baseURL+"/create").set(e.config).send(t).end(function(t,n){if(t)return r(t);if("00"===n.body.response_code)e.token=n.body.token,e.url=n.body.response_text,o(e.confirm());else{var c=new Error("Failed to create invoice.");c.data=n.body,r(c)}})})},CheckoutInvoice.prototype.confirm=function(e){var t=this,o=e||t.token;return new Promise(function(e,r){request.get(t.baseURL+"/confirm/"+o).set(t.config).end(function(o,n){if(o)return r(o);var c=n.body;if("00"===c.response_code)t.status=c.status,t.responseText=c.response_text,"completed"===t.status&&(t.customer=c.customer,t.receiptURL=c.receipt_url,c.custom_data&&Object.keys(c.custom_data).length>0&&(t.customData=c.custom_data)),t.totalAmount=c.invoice.total_amount,e();else{var i=new Error("Could not confirm invoice status.");i.data=c,r(i)}})})},module.exports=CheckoutInvoice;

},{"./invoice":4,"bluebird":6,"superagent":10}],2:[function(require,module,exports){
function DirectPay(e){if(!e||!e.config)throw new Error("Must be initialized with instance of paydunya.Setup");this.config=e.config,this.baseURL=e.baseURL+"/direct-pay"}var request=require("superagent"),Promise=require("bluebird"),util=require("util");DirectPay.prototype.creditAccount=function(e,t){var r=this,i={account_alias:e,amount:Number(t)};return new Promise(function(n,o){request.post(r.baseURL+"/credit-account").set(r.config).send(i).end(function(i,a){if(i)return o(i);if("00"===a.body.response_code)r.responseText=a.body.response_text,r.description=a.body.description,r.transactionID=a.body.transaction_id,n();else{var c=new Error(new Error(util.format("Failed to credit account. Please ensure %s and %s are valid OR check your account balance.",e,t)));c.data=a.body,o(c)}})})},module.exports=DirectPay;

},{"bluebird":6,"superagent":10,"util":13}],3:[function(require,module,exports){
(function (process){
...
},{"./support/isBuffer":12,"_process":8,"inherits":11}]},{},[3]);
