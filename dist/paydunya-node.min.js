...
function CheckoutInvoice(e,t){Invoice.call(this,e,t),this.baseURL=this.baseURL+"/checkout-invoice"}var Invoice=require("./invoice"),request=require("superagent"),Promise=require("bluebird");CheckoutInvoice.prototype=Object.create(Invoice.prototype),CheckoutInvoice.prototype.constructor=CheckoutInvoice,CheckoutInvoice.prototype.create=function(){var e=this,t=e.generateRequestBody();return new Promise(function(o,r){request.post(e.baseURL+"/create").set(e.config).send(t).end(function(t,n){if(t)return r(t);if("00"===n.body.response_code)e.token=n.body.token,e.url=n.body.response_text,o(e.confirm());else{var c=new Error("Failed to create invoice.");c.data=n.body,r(c)}})})},CheckoutInvoice.prototype.confirm=function(e){var t=this,o=e?e:t.token;return new Promise(function(e,r){request.get(t.baseURL+"/confirm/"+o).set(t.config).end(function(o,n){if(o)return r(o);var c=n.body;if("00"===c.response_code)t.status=c.status,t.responseText=c.response_text,"completed"===t.status&&(t.customer=c.customer,t.receiptURL=c.receipt_url,c.custom_data&&Object.keys(c.custom_data).length>0&&(t.customData=c.custom_data)),t.totalAmount=c.invoice.total_amount,e();else{var i=new Error("Could not confirm invoice status.");i.data=c,r(i)}})})},module.exports=CheckoutInvoice;

},{"./invoice":8,"bluebird":10,"superagent":11}],6:[function(require,module,exports){
...
},{"bluebird":10,"superagent":11,"util":4}],7:[function(require,module,exports){
(function (process){
function Setup(e){this.config={},this.config["PAYDUNYA-MASTER-KEY"]=e&&e.masterKey||process.env.PAYDUNYA_MASTER_KEY,this.config["PAYDUNYA-PRIVATE-KEY"]=e&&e.privateKey||process.env.PAYDUNYA_PRIVATE_KEY,this.config["PAYDUNYA-TOKEN"]=e&&e.token||process.env.PAYDUNYA_TOKEN,this.config["Content-Type"]="application/json",e&&e.mode&&"test"===e.mode.toLowerCase()?this.baseURL="https://app.paydunya.com/sandbox-api/v1":this.baseURL="https://app.paydunya.com/api/v1"}function Store(e){if(!e||!e.name)throw new Error("Invalid parameters.");this.name=e.name,e.tagline&&(this.tagline=e.tagline),e.phoneNumber&&(this.phone_number=e.phoneNumber),e.postalAddress&&(this.postal_address=e.postalAddress),e.logoURL&&(this.logo_url=e.logoURL),e.websiteURL&&(this.website_url=e.websiteURL),e.cancelURL&&(this.cancel_url=e.cancelURL),e.returnURL&&(this.return_url=e.returnURL)}exports.Setup=exports.setup=Setup,exports.Store=exports.store=Store,exports.CheckoutInvoice=exports.checkoutInvoice=require("./checkout-invoice"),exports.OnsiteInvoice=exports.onsiteInvoice=require("./onsite-invoice"),exports.DirectPay=exports.directPay=require("./direct-pay");
}).call(this,require('_process'))
},{"./checkout-invoice":5,"./direct-pay":6,"./onsite-invoice":9,"_process":2}],8:[function(require,module,exports){
function Invoice(t,e){if(!(t&&e&&t.config["PAYDUNYA-MASTER-KEY"]&&t.config["PAYDUNYA-PRIVATE-KEY"]&&t.config["PAYDUNYA-TOKEN"]&&e.name))throw new Error("Invalid parameters;");this.baseURL=t.baseURL,this.config=t.config,e.return_url&&(this.returnURL=e.return_url),e.cancel_url&&(this.cancelURL=e.cancel_url),this.store=e,this.description="",this.items={},this.customData={},this.taxes={},this.totalAmount=0}Invoice.prototype.addItem=function(t,e,i,s,n){if(!t)throw new Error("Invalid parameters; name is required.");var o=Object.keys(this.items).length+1;this.items["item_"+o]={name:t,quantity:e||0,unit_price:i||0,total_price:s||0},n&&(this.items["item_"+o].description=n)},Invoice.prototype.addTax=function(t,e){if(!t||"string"!=typeof t||"number"!=typeof Number(e))throw new Error("Invalid parameters.");var i=Object.keys(this.taxes).length+1;this.taxes["tax_"+i]={name:t,amount:Number(e)}},Invoice.prototype.addCustomData=function(t,e){if(!t||!e)throw new Error("Invalid parameters.");this.customData[t]=e},Invoice.prototype.generateRequestBody=function(){if(!(this.store&&this.store.name&&this.baseURL&&this.totalAmount>0))throw new Error("Invalid parameters. Initialize Invoice with valid instances of Setup and Store. Total amount must also be set.\neg: var invoice = new Invoice; invoice.init(setup, store); invoice.setTotalAmount(40)");var t={invoice:{total_amount:this.totalAmount},store:this.store};return this.description&&(t.invoice.description=this.description),Object.keys(this.items).length>0&&(t.invoice.items=this.items),(this.returnURL||this.cancelURL)&&(t.actions={},this.returnURL&&(t.actions.return_url=this.returnURL),this.cancelURL&&(t.actions.cancel_url=this.cancelURL)),Object.keys(this.taxes).length>0&&(t.invoice.taxes=this.taxes),Object.keys(this.customData).length>0&&(t.custom_data=this.customData),t},module.exports=Invoice;
...
},{"./invoice":8,"bluebird":10,"superagent":11}],10:[function(require,module,exports){
(function (process,global){
